...
nohup $JAVA_HOME/bin/java $JVM_OPTIONS  $DEFAULT_OPTS $APP_OPTIONS  -classpath "$CLASSPATH"  $START_MAIN_CLASS $APP_ARGS $@  > $PROJECT_HOME/std.log &
tail -f $PROJECT_HOME/std.log